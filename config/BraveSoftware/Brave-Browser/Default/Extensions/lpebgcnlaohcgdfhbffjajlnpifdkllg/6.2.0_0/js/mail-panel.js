(() => {
 var __webpack_modules__ = {
  ...
  1010: function(module) {
   module.exports = function() {
    ...
    var arrayForEach = unapply(Array.prototype.forEach), arrayPop = unapply(Array.prototype.pop), arrayPush = unapply(Array.prototype.push), stringToLowerCase = unapply(String.prototype.toLowerCase), stringMatch = unapply(String.prototype.match), stringReplace = unapply(String.prototype.replace), stringIndexOf = unapply(String.prototype.indexOf), stringTrim = unapply(String.prototype.trim), regExpTest = unapply(RegExp.prototype.test), typeErrorCreate = unconstruct(TypeError);
    ...
    function addToSet(set, array, transformCaseFunc) {
     transformCaseFunc = transformCaseFunc || stringToLowerCase, setPrototypeOf && setPrototypeOf(set, null);
    ...
    function clone(object) {
     var property, newObject = create(null);
    ...
    function createDOMPurify() {
     ...
     var trustedTypesPolicy = _createTrustedTypesPolicy(trustedTypes, originalDocument), emptyHTML = trustedTypesPolicy ? trustedTypesPolicy.createHTML("") : "", _document = document, implementation = _document.implementation, createNodeIterator = _document.createNodeIterator, createDocumentFragment = _document.createDocumentFragment, getElementsByTagName = _document.getElementsByTagName, importNode = originalDocument.importNode, documentMode = {};
     try {
      documentMode = clone(document).documentMode ? document.documentMode : {};
     } catch (_) {}
     var hooks = {};
     DOMPurify.isSupported = "function" == typeof getParentNode && implementation && void 0 !== implementation.createHTMLDocument && 9 !== documentMode;
     var PARSER_MEDIA_TYPE, transformCaseFunc, MUSTACHE_EXPR$1 = MUSTACHE_EXPR, ERB_EXPR$1 = ERB_EXPR, DATA_ATTR$1 = DATA_ATTR, ARIA_ATTR$1 = ARIA_ATTR, IS_SCRIPT_OR_DATA$1 = IS_SCRIPT_OR_DATA, ATTR_WHITESPACE$1 = ATTR_WHITESPACE, IS_ALLOWED_URI$1 = IS_ALLOWED_URI, ALLOWED_TAGS = null, DEFAULT_ALLOWED_TAGS = addToSet({}, [].concat(_toConsumableArray(html$1), _toConsumableArray(svg$1), _toConsumableArray(svgFilters), _toConsumableArray(mathMl$1), _toConsumableArray(text))), ALLOWED_ATTR = null, DEFAULT_ALLOWED_ATTR = addToSet({}, [].concat(_toConsumableArray(html), _toConsumableArray(svg), _toConsumableArray(mathMl), _toConsumableArray(xml))), CUSTOM_ELEMENT_HANDLING = Object.seal(Object.create(null, {
      tagNameCheck: {
       writable: !0,
       configurable: !1,
       enumerable: !0,
     ...
     })), FORBID_TAGS = null, FORBID_ATTR = null, ALLOW_ARIA_ATTR = !0, ALLOW_DATA_ATTR = !0, ALLOW_UNKNOWN_PROTOCOLS = !1, SAFE_FOR_TEMPLATES = !1, WHOLE_DOCUMENT = !1, SET_CONFIG = !1, FORCE_BODY = !1, RETURN_DOM = !1, RETURN_DOM_FRAGMENT = !1, RETURN_TRUSTED_TYPE = !1, SANITIZE_DOM = !0, SANITIZE_NAMED_PROPS = !1, SANITIZE_NAMED_PROPS_PREFIX = "user-content-", KEEP_CONTENT = !0, IN_PLACE = !1, USE_PROFILES = {}, FORBID_CONTENTS = null, DEFAULT_FORBID_CONTENTS = addToSet({}, [ "annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp" ]), DATA_URI_TAGS = null, DEFAULT_DATA_URI_TAGS = addToSet({}, [ "audio", "video", "img", "source", "image", "track" ]), URI_SAFE_ATTRIBUTES = null, DEFAULT_URI_SAFE_ATTRIBUTES = addToSet({}, [ "alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns" ]), MATHML_NAMESPACE = "http://www.w3.org/1998/Math/MathML", SVG_NAMESPACE = "http://www.w3.org/2000/svg", HTML_NAMESPACE = "http://www.w3.org/1999/xhtml", NAMESPACE = HTML_NAMESPACE, IS_EMPTY_INPUT = !1, SUPPORTED_PARSER_MEDIA_TYPES = [ "application/xhtml+xml", "text/html" ], DEFAULT_PARSER_MEDIA_TYPE = "text/html", CONFIG = null, formElement = document.createElement("form"), isRegexOrFunction = function(testValue) {
      return testValue instanceof RegExp || testValue instanceof Function;
     }, _parseConfig = function(cfg) {
      CONFIG && CONFIG === cfg || (cfg && "object" === _typeof(cfg) || (cfg = {}), cfg = clone(cfg), 
      PARSER_MEDIA_TYPE = PARSER_MEDIA_TYPE = -1 === SUPPORTED_PARSER_MEDIA_TYPES.indexOf(cfg.PARSER_MEDIA_TYPE) ? DEFAULT_PARSER_MEDIA_TYPE : cfg.PARSER_MEDIA_TYPE, 
      transformCaseFunc = "application/xhtml+xml" === PARSER_MEDIA_TYPE ? function(x) {
       return x;
      } : stringToLowerCase, ALLOWED_TAGS = "ALLOWED_TAGS" in cfg ? addToSet({}, cfg.ALLOWED_TAGS, transformCaseFunc) : DEFAULT_ALLOWED_TAGS, 
      ...
      KEEP_CONTENT = !1 !== cfg.KEEP_CONTENT, IN_PLACE = cfg.IN_PLACE || !1, IS_ALLOWED_URI$1 = cfg.ALLOWED_URI_REGEXP || IS_ALLOWED_URI$1, 
      NAMESPACE = cfg.NAMESPACE || HTML_NAMESPACE, cfg.CUSTOM_ELEMENT_HANDLING && isRegexOrFunction(cfg.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (CUSTOM_ELEMENT_HANDLING.tagNameCheck = cfg.CUSTOM_ELEMENT_HANDLING.tagNameCheck), 
      ...
      delete FORBID_TAGS.tbody), freeze && freeze(cfg), CONFIG = cfg);
     }, MATHML_TEXT_INTEGRATION_POINTS = addToSet({}, [ "mi", "mo", "mn", "ms", "mtext" ]), HTML_INTEGRATION_POINTS = addToSet({}, [ "foreignobject", "desc", "title", "annotation-xml" ]), COMMON_SVG_AND_HTML_ELEMENTS = addToSet({}, [ "title", "style", "font", "a", "script" ]), ALL_SVG_TAGS = addToSet({}, svg$1);
     ...
     var _checkValidNamespace = function(element) {
      ...
      "application/xhtml+xml" === PARSER_MEDIA_TYPE && (dirty = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + dirty + "</body></html>");
      ...
      return createNodeIterator.call(root.ownerDocument || root, root, NodeFilter.SHOW_ELEMENT | NodeFilter.SHOW_COMMENT | NodeFilter.SHOW_TEXT, null, !1);
     }, _isClobbered = function(elm) {
      return elm instanceof HTMLFormElement && ("string" != typeof elm.nodeName || "string" != typeof elm.textContent || "function" != typeof elm.removeChild || !(elm.attributes instanceof NamedNodeMap) || "function" != typeof elm.removeAttribute || "function" != typeof elm.setAttribute || "string" != typeof elm.namespaceURI || "function" != typeof elm.insertBefore);
     }, _isNode = function(object) {
      return "object" === _typeof(Node) ? object instanceof Node : object && "object" === _typeof(object) && "number" == typeof object.nodeType && "string" == typeof object.nodeName;
      ...
      !0;
      if (regExpTest(/[\u0080-\uFFFF]/, currentNode.nodeName)) return _forceRemove(currentNode), 
      !0;
      var tagName = transformCaseFunc(currentNode.nodeName);
      if (_executeHook("uponSanitizeElement", currentNode, {
       tagName,
       allowedTags: ALLOWED_TAGS
      }), currentNode.hasChildNodes() && !_isNode(currentNode.firstElementChild) && (!_isNode(currentNode.content) || !_isNode(currentNode.content.firstElementChild)) && regExpTest(/<[/\w]/g, currentNode.innerHTML) && regExpTest(/<[/\w]/g, currentNode.textContent)) return _forceRemove(currentNode), 
      !0;
      if ("select" === tagName && regExpTest(/<template/i, currentNode.innerHTML)) return _forceRemove(currentNode), 
      !0;
      if (!ALLOWED_TAGS[tagName] || FORBID_TAGS[tagName]) {
       ...
       if (KEEP_CONTENT && !FORBID_CONTENTS[tagName]) {
        ...
        if (childNodes && parentNode) for (var i = childNodes.length - 1; i >= 0; --i) parentNode.insertBefore(cloneNode(childNodes[i], !0), getNextSibling(currentNode));
       }
      ...
      !0) : "noscript" !== tagName && "noembed" !== tagName || !regExpTest(/<\/no(script|embed)/i, currentNode.innerHTML) ? (SAFE_FOR_TEMPLATES && 3 === currentNode.nodeType && (content = currentNode.textContent, 
      ...
      if (attributes) {
       ...
       for (l = attributes.length; l--; ) {
        ...
        value = hookEvent.attrValue, !hookEvent.forceKeepAttr && (_removeAttribute(name, currentNode), 
        hookEvent.keepAttr)) if (regExpTest(/\/>/i, value)) _removeAttribute(name, currentNode); else {
         ...
         if (_isValidAttribute(lcTag, lcName, value)) {
          ...
          value = SANITIZE_NAMED_PROPS_PREFIX + value), trustedTypesPolicy && "object" === _typeof(trustedTypes) && "function" == typeof trustedTypes.getAttributeType) if (namespaceURI) ; else switch (trustedTypes.getAttributeType(lcTag, lcName)) {
          case "TrustedHTML":
     ...
     return DOMPurify.sanitize = function(dirty) {
      var body, importedNode, currentNode, oldNode, returnNode, cfg = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      if ((IS_EMPTY_INPUT = !dirty) && (dirty = "\x3c!--\x3e"), "string" != typeof dirty && !_isNode(dirty)) {
      ...
      } else if (dirty instanceof Node) 1 === (importedNode = (body = _initDocument("\x3c!----\x3e")).ownerDocument.importNode(dirty, !0)).nodeType && "BODY" === importedNode.nodeName || "HTML" === importedNode.nodeName ? body = importedNode : body.appendChild(importedNode); else {
      ...
      if (RETURN_DOM) {
       ...
       return ALLOWED_ATTR.shadowroot && (returnNode = importNode.call(originalDocument, returnNode, !0)), 
       returnNode;
      }
      ...
      SAFE_FOR_TEMPLATES && (serializedHTML = stringReplace(serializedHTML, MUSTACHE_EXPR$1, " "), 
      ...
      CONFIG || _parseConfig({});
      var lcTag = transformCaseFunc(tag), lcName = transformCaseFunc(attr);
 ...
 module), (() => {
  ...
  var preload = __webpack_require__(2107);
  const rater = __webpack_require__(2696), v = preload.coerce(chrome.runtime.getManifest().version), key = `rating-${preload.major(v)}`;
  let r;
  const onRating = (value, done) => {
   r.setRating(value), function(key, value, ns, responseHandler) {
    _.isFunction(ns) && (responseHandler = ns, ns = "general"), chrome.runtime.sendMessage({
     id: "set-option",
     key,
     value,
     namespace: ns
  ...
  const mail_panel_ = __webpack_require__(1888), purify = __webpack_require__(1010)(window);
  let _tabs, _options, _animationTimer;
  function onClickHelp(evt) {
   chrome.tabs.create({
    url: go(config_brand.helpURL)
  ...
  function onClickLogin(evt, email) {
   evt.preventDefault(), async function(email) {
    ...
    "oauth2" === provider.subtype ? function(email, responseHandler) {
     chrome.runtime.sendMessage({
      id: "launch-oauth2-web-auth-flow",
      email: email.trim().toLowerCase()
     }, responseHandler);
    }(email) : (p => p.provider === mail_providers_gmail.provider)(provider) ? function(email, responseHandler) {
     chrome.runtime.sendMessage({
  ...
  const debouncedRefresh = mail_panel_.debounce(onRefresh, seconds(2), {
   leading: !1,
   trailing: !0
  });
  function onClickDeleteMessage(evt) {
   ...
   }(this.getAttribute("data-account"), this.getAttribute("data-email-id"), (_ => {
  ...
  function showProcessedMessage(el, text) {
   ...
   span.classList.add("email"), span.classList.add("email-processed"), span.innerHTML = text, 
  ...
  function onClickEmail(evt) {
   ...
   }(this.getAttribute("data-account"), this.getAttribute("data-email-id"), this.getAttribute("href"), (_ => {})), 
   evt.preventDefault(), window.close();
  }
  function onClickOpenWebmail(evt) {
   ...
   if (sectionEl && sectionEl.classList.contains("logged-out")) {
  ...
  function removeEmailEventListenersInSection(sectionEl) {
   const emailEls = sectionEl.getElementsByClassName("email"), emailDeleteEls = sectionEl.getElementsByClassName("email-delete"), emailStatusEls = sectionEl.getElementsByClassName("email-status");
  ...
  function addEmailEventListenersInSection(sectionEl) {
   const emailEls = sectionEl.getElementsByClassName("email"), emailDeleteEls = sectionEl.getElementsByClassName("email-delete"), emailMarkAsReadEls = sectionEl.getElementsByClassName("email-status");
   Array.from(emailEls).forEach((el => {
  ...
  function createMessageRow(account, message) {
   const markAsReadButton = account.isBrandAccount ? `\n      <button class="email-status" type="button" data-account="${account.email}" data-email-id="${message.id}" aria-describedby="mark_read_tt" role="tooltip">\n        <svg role="img" aria-hidden="true"><use xlink:href="../images/mark-read-dot.svg#icon"></use></svg>\n      </button>\n      ` : '<span class="email-status-empty"></span>', deleteButtonMarkup = account.canDelete ? `\n    <button class="email-delete" type="button" data-account="${account.email}" data-email-id="${message.id}" aria-describedby="delete_email_tt" role="tooltip">\n      <svg role="img" aria-hidden="true"><use xlink:href="../images/trash.svg#icon"></use></svg>\n    </button>\n  ` : "", sender = purify.sanitize(message.sender || "", {
    ALLOWED_TAGS: []
  ...
  function onRequestAccountsMessage(obj) {
   ...
   for (let i = 0; i < accounts.length; i++) {
    ...
    if (account.messages.forEach((m => {
     ...
     account.isLoggedIn ? sectionEl.classList.remove("logged-out") : sectionEl.classList.contains("logged-out") && sectionEl.classList.add("logged-out");
     ...
     translateElements(sectionEl, config_brand.login.name), translateTooltips(sectionEl), 
     addEmailEventListenersInSection(sectionEl), E(`account-link_${sectionId}`).addEventListener("click", onClickOpenWebmail, !1), 
  ...
  function onRefresh(evt) {
   ...
   showError(), responseHandler = onRequestAccountsMessage, chrome.runtime.sendMessage({
    id: "request-aticve-account-data"
   }, responseHandler);
  }
  function onLogout(evt) {
   ...
   responseHandler = response => {
    ...
    id: "logout-from-all-accounts"
   }, responseHandler), chrome.tabs.create({
    url: go(config_brand.searchOnLogoutURL)
   });
  }
  window.addEventListener("DOMContentLoaded", (function() {
   ...
   chrome.runtime.onMessage.addListener((account => {
    ...
    case "ui-logged-in":
     ...
     sectionEl && sectionEl.classList.contains("logged-out") && sectionEl.classList.remove("logged-out");
    }
   })), onRefresh();
  }), !1);
 })();
